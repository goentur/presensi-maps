...
<div class="card">
    ...
    <div class="card-body">
        <div class="alert alert-info">Silahkan ubah koordinat lokasi pada tombol <button class="btn btn-sm btn-icon btn-primary"><i class="fa-solid fa-location-dot"></i></button></div>
